...
function bitadd(a,b)
{
    ...
    // console.log(typeof(mat[0][5]))
    // setgreencolor(1,document.getElementById('binar').innerHTML)
    // setgreencolor(2,document.getElementById('2s').innerHTML)
    // setgreencolor(3,document.getElementById('1s').innerHTML)
    // setgreencolor(4,document.getElementById('unsigned').innerHTML)
    // setgreencolor(5,document.getElementById('signed').innerHTML)
